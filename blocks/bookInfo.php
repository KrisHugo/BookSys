...
<div class="box">
	...
	<div class="row">
					...
					<tbody id="bookCodes">
                   		 <?php if (sizeof($details) > 0) :?>
        						...
        						<tr>
        							...
        							<td><?=$v['status']?></td>
        							<td>
        								<a class="button special small fit" href="<?='app/borrow.php?uniqueCode='.$v['uniqueCode'].'&bookId='.$book['id']?>">借出</a>
    								</td>
        						</tr>
                        		<?php endforeach;?>
                    	<?php endif;?>
		...
		<ul class="actions special">
			<li><a href="<?='backend.php?ctr=update&update='.$book['id']?>" class="button special small fit alt">修改</a></li>
		</ul>
		<?php endif;?>
        <div class="col-12">
            <hr/>
